...
<div class="container-fluid top-menu-container">
	<div class="row-fluid">
		<div class="span9">
{include file="components/tabs/tabsmenue-project.tpl" milestab = "active"}
	...
	<div id="content-left-in">
		<div class="miles">
			...
			<div class="breadcrumb">
				<a href="managemilestone.php?action=showproject&amp;id={$project.ID}"><img src="./templates/standard/images/symbols/projects.png" alt="" />{$projectname|truncate:40:"...":true}</a>
			</div>
...
{/if}
			...
			<h2>{#addmilestone#}</h2>
				...
				<form novalidate class="main" method="post" action="managemilestone.php?action=add&amp;id={$project.ID}" {literal} onsubmit="return validateCompleteForm(this);"{/literal} >
					<fieldset>
						<div class="row">
							<label for="name">{#name#}:</label><input type="text" class="text" name="name" id="name" required="1" realname="{#name#}" />
						</div>
